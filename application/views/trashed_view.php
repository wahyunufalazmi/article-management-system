...
<div class="offcanvas offcanvas-start bg-dark" data-bs-scroll="true" data-bs-backdrop="false" tabindex="-1" id="offcanvasScrolling" aria-labelledby="offcanvasScrollingLabel">
  ...
  <div class="offcanvas-body">
   ...
   <a href="<?= base_url('article/trashed') ?>"><font color="white">Trashed</font></a>
    ...
    <center><h1><i class='far fa-trash-alt' style='font-size:48px;color:red'></i>Trash</h1></center>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td onclick="javascript : return confirm('Are you sure to delete permanently ?')">
              <a href="<?php echo site_url('article/delete/'.$row->id);?>" class="btn btn-sm btn-danger"><i class='far fa-trash-alt'></i></a>
            </td>
          <?php }?>
        </tbody>
      </table>
